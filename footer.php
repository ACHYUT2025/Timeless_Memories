        ...
        <div class="max-w-7xl mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div>
                    ...
                    "I am a passionate photographer dedicated to capturing the breathtaking beauty and serene essence of the world’s landscapes, from towering mountains to tranquil forests, preserving nature’s timeless wonders through expert photography."                    </p>
                </div>
                <div>
